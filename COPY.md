# NanoDoodle Trade — Landing Page Copy

> All user-facing copy extracted from `src/app/page.tsx` and `src/app/nav.tsx` for review.

---

## Meta

- **Page title:** NanoDoodle Trade | Global Sourcing Experts
- **Meta description:** Melbourne-based product sourcing and international trade experts. AI-powered market intelligence connecting global innovation to the Australian market.

---

## Navigation

- **Brand:** NanoDoodle Trade
- **Links:** What We Seek · Why Us · How We Work
- **CTA:** Contact
...
- **Label:** Market Ready
- **Body:** Verified supply chains for the Australian consumer landscape.

---

## Section · What We Seek
...
## Section · How We Work (Pipeline)

- **Eyebrow:** Pipeline
- **Heading:** Our Sourcing Pipeline
- **Subhead:** From initial discovery to long-term market dominance, we manage the entire lifecycle of trade.

### Pipeline steps (6)

| # | Title | Body |
|---|---|---|
| 01 | Product Sourcing | Identifying high-quality goods across global manufacturing hubs through our trusted network. |
| 02 | Manufacturer Matching | Pairing specific Australian requirements with the right production facilities. |
| 03 | Market Research | Deep-dive analysis of the Australian competitive landscape and regulatory compliance. |
| 04 | OEM / ODM | Custom manufacturing opportunities tailored for unique brand positioning in Australia. |
| 05 | Long-term Partnerships | Building sustainable trade bridges that survive fluctuating market conditions. |
| 06 | AI-Enabled Trade | Deploying future-state software tools for real-time logistics and demand forecasting. |
...
| Label | Value |
|---|---|
| Email Us | trade@nanodoodle.com |
| Web | trade.nanodoodle.com |
...
- **Brand:** NanoDoodle Trade
- **Tagline:** Expert sourcing and international trade solutions for the modern era.
...
### Copyright
© {current year} NanoDoodle Trade. All rights reserved.
